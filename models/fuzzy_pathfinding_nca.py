...
class FuzzyPathfindingNCA(PathfindingNN):
    # TODO: Maybe interpret continuous wall weight as proportional to edge cost, then always move along min cost edge.
    #   Should we worry about backtracking too?
